...
#** QUESTION 8: According to Schmitz et al. 2004, when predators and prey both have broad
#       areas of habitat use (or habitat domain), which predator hunting mode is most
#       likely to cause a trait-mediated indirect interaction? 
